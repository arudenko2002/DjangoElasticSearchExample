...
class ReceiveTotalCheckins(models.Manager):
    def requestURL(self,q,page_value,size_value):
        ...
        port=9200
        index="alexey2_index"
        url="%s:%s/%s/businesses/_search" % ("http://"+host,port,index)
...
if __name__ == '__main__':
    ...
    print(data)
    data = rtc.receiveTotalCheckins(q="Performance",size="10",page="0")
    print(data)
    data = rtc.receiveTotalCheckins(q="Auto",size="10",page="0")
    print(data)
    pass